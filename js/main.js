...
const PROJECTS_DATA = {
  ...
  'isi-conflict-analysis': {
    ...
    context: 'ISI Foundation (Turin, IT) — Research Internship (April 2024 – June 2024)',
    ...
    technologies: ['Python', 'Pandas', 'Geopandas', 'Matplotlib', 'Shapely', 'Geospatial Analysis', 'ACLED Dataset', 'Data Science']
  },
        ...
        if (project.pdfUrl) {
          modalDocContainer.innerHTML = `
            <a href="${project.pdfUrl}" target="_blank" rel="noopener noreferrer" class="btn btn-primary" style="padding: 0.6rem 1.25rem; font-size: 0.9rem;">
              ...
              <span>Read Full Master's Thesis (PDF)</span>
            </a>
          `;
